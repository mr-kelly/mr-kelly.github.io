...
const pages = {
  "zh-CN": {
    ...
    title: "CAIO Office｜企业 AI 转型与研发 AI 原生转型｜Kelly AI",
    description: "Kelly 担任 CAIO Lead，以嵌入式持续合作方式带队，覆盖企业 AI 转型与研发 AI 原生转型；每周确定优先级、推进真实业务并验收结果。",
    home: "/ai/",
    nav: ["两种路径", "前 30 天", "交付验收", "合作边界", "联系"],
    navTargets: ["#paths", "#first-30-days", "#outcomes", "#boundaries", "#contact"],
    eyebrow: "Kelly AI 企业 AI 落地服务",
    heroTitle: "CAIO Office",
    heroLead: "由 Kelly 担任 CAIO Lead，以嵌入式持续合作方式进入管理层和团队，从经营目标到研发交付，每周推进并验收最重要的结果。",
    heroPrimary: "选择切入路径",
    heroSecondary: "联系 Kelly",
    heroSignals: [["企业 AI 转型", "跨部门优先级与业务闭环"], ["研发 AI 原生转型", "交付透明、AI Coding 与技术资产"], ["FDE 工作包", "需要系统实施时按范围配置"]],
    problemLabel: "为什么需要 CAIO",
    problemTitle: "AI 工具已经很多，真正缺的是把目标、执行和验收串起来的人",
    problemIntro: "战略层知道 AI 重要，员工也开始试工具，但中间没有人持续决定先做什么、调动谁来做、怎样证明做成。CAIO Office 补上的不是一个职位名称，而是一套经营机制。",
    ...
    pathsIntro: "两条路径共用同一套 CAIO Office 工作节奏，不要求同时采购。可以从研发 AI 原生转型切入再扩展到企业 AI 转型，也可以先确定公司级优先级，再进入研发 AI 原生转型。",
    paths: [
      { id: "enterprise", number: "01", title: "企业 AI 转型", fit: "适合管理层已认可 AI，但部门各自试工具、没有统一路线和业务闭环的企业。", focus: ["从经营目标筛选最值得投入的 AI 场景", "协调业务、产品、技术、数据与安全团队", "建立周度执行和月度管理层复盘", "让一个跨部门业务闭环先跑起来"], outputs: ["AI 机会与优先级路线图", "跨部门任务与负责人机制", "可验收业务成果与管理层决策"] },
      { id: "rd", number: "02", title: "研发 AI 原生转型", fit: "适合研发持续投入却交付不透明、文档断层，或 AI Coding 只停留在局部写代码的企业。", focus: ["梳理目标、需求、代码、测试与发布价值流", "建立任务／PR／测试／签收证据链", "恢复产品、架构、接口与发布文档", "变成团队可复用的 AI 原生研发方法"], outputs: ["研发价值流与交付看板", "一个真实任务的完整研发闭环", "产品技术资产与团队优化建议"] }
    ],
    cadenceLabel: "共同工作节奏",
    cadenceTitle: "不是交一份报告，而是每周推动一个真实结果",
    cadenceIntro: "CAIO Office 是客户与 Kelly 共同成立的虚拟组织，不是远程给建议的外部顾问。客户需委派一名种子人员，建议来自业务侧——业务的人没有技术包袱，更敢把 AI 用到极限；代码落地、系统上线和风险控制仍由技术把关。CTO 可以加入，角色分工在启动前一起确定。",
    ...
    boundariesTitle: "CAIO Office 对推进负责，但不制造无法验证的承诺",
    ...
    trustText: "Kelly 担任 CAIO Lead。他是 Buda、Vika 与 AITable 创始人、前喜茶创始 CTO，拥有百万行级企业软件研发与交付经验，带过 150 人以上跨职能团队，也长期以业务目标驱动团队与 AI 协作。",
    contactLabel: "下一步",
    contactTitle: "带一个真实问题来，先判断从哪条路径切入",
    contactText: "准备好最希望改变的业务结果、当前负责人、一个候选流程或代码仓库，以及你认为“做成”的标准。我们先做一次需求判断，再确认是否适合 CAIO Office 和 FDE。",
  ...
  en: {
    output: "en/caio/index.html", canonical: "https://mr-kelly.github.io/ai/en/caio/", title: "CAIO Office | Enterprise AI & AI-Native R&D Transformation | Kelly AI", description: "Kelly serves as CAIO Lead through an embedded continuous CAIO Office engagement across enterprise AI and AI-native R&D transformation, with evidence-based delivery and optional FDE work packages.", home: "/ai/en/", nav: ["Tracks", "First 30 days", "Outcomes", "Boundaries", "Contact"], navTargets: ["#paths", "#first-30-days", "#outcomes", "#boundaries", "#contact"], eyebrow: "Kelly AI Deployment Service", heroTitle: "CAIO Office", heroLead: "Kelly serves as CAIO Lead through an embedded continuous engagement, turning business goals into weekly priorities, execution, and evidence-based review.", heroPrimary: "Choose a track", heroSecondary: "Contact Kelly", heroSignals: [["Enterprise AI Transformation", "Cross-functional priorities and operating loops"], ["AI-Native R&D Transformation", "Visible delivery, AI coding, and durable assets"], ["FDE work packages", "Scoped engineering when implementation is needed"]], problemLabel: "Why a CAIO", problemTitle: "Tools are abundant. The missing role connects direction, execution, and acceptance.", problemIntro: "Leadership knows AI matters and employees are experimenting, but nobody continuously chooses the work, aligns owners, and proves the result. A CAIO Office installs that operating mechanism.", problemSignals: [["Scattered direction", "Departments run disconnected tool experiments."], ["Broken execution", "Advice has no owner, deadline, or weekly follow-through."], ["Unproven outcomes", "Demos lack baselines, tests, and business acceptance."], ["Lost assets", "Knowledge stays in people and chat histories."]], pathsLabel: "Two engagement tracks", pathsTitle: "Start with the company's most important constraint", pathsIntro: "Both tracks use the same CAIO Office cadence and do not need to be purchased together. Start with one, then expand as evidence accumulates.", paths: [{id:"enterprise",number:"01",title:"Enterprise AI Transformation",fit:"For companies with leadership support but fragmented department experiments and no shared roadmap.",focus:["Select AI opportunities from business goals","Align business, product, engineering, data, and security","Run weekly execution and monthly executive reviews","Make one cross-functional operating loop work first"],outputs:["AI opportunity portfolio and roadmap","Cross-functional ownership system","Accepted business outcome and executive decision"]},{id:"rd",number:"02",title:"AI-Native R&D Transformation",fit:"For companies investing in engineering without delivery visibility, durable documentation, or an end-to-end AI coding method.",focus:["Map goals, requirements, code, tests, and release flow","Build a task / PR / test / sign-off evidence chain","Recover product, architecture, API, and release documentation","Turn working practice into an AI-native engineering method"],outputs:["R&D value stream and delivery view","One complete real-task engineering loop","Technical assets and team optimization recommendations"]}], cadenceLabel:"Shared operating cadence",cadenceTitle:"Not another report: one real outcome moves every week",cadenceIntro:"A CAIO Office is a virtual unit the client and Kelly stand up together, not an outside adviser sending recommendations. The client nominates a seed owner — ideally from the business side, who carries no engineering assumptions and will push AI further; engineering still owns code, release, and risk. A CTO can join; roles are agreed before kickoff.",cadence:[["01","Weekly diagnosis","Review goals, progress, blockers, and new opportunities."],["02","Set the work","Choose the top priority and define outcome, owner, deadline, and acceptance."],["03","Lead execution","Coordinate the team and AI Agents across business, data, workflow, or systems."],["04","Review and reset","Validate evidence, retain assets, and set the next actions."]], firstLabel:"First 30 days",firstTitle:"Establish a baseline before scaling",firstIntro:"The first month does not promise a company-wide transformation. Prove one bounded scenario and use its evidence to decide what comes next.",firstSteps:[["Week 1","See the system","Map goals, process, systems, data, roles, and risk."],["Week 2","Choose the pilot","Freeze one valuable, data-accessible, human-verifiable scenario."],["Week 3","Close the loop","Run task definition, execution, testing, evidence, and human sign-off."],["Week 4","Make the decision","Review baseline, outcome, risk, and a Go / No-Go recommendation."]], outcomesLabel:"Delivery and acceptance",outcomesTitle:"Visible every week, decision-ready every month",outcomesIntro:"Metrics are not copied from examples. Establish the current baseline, then freeze definitions, data scope, thresholds, and sign-off owners together.",deliverablesTitle:"Core deliverables",deliverables:["Weekly work with owners, deadlines, and definition of done","A real business outcome that continues to advance","Problem, cause, change, test, evidence, and sign-off records","Methods, documentation, data, Agent Skills, and next-stage roadmap"],metricsTitle:"Typical evaluation dimensions",metrics:["Delivery cycle and wait time","Task and evidence traceability","Quality, rework, and regression defects","Human intervention and team independence","Business outcomes and executive decision speed"],boundariesLabel:"Engagement boundaries",boundariesTitle:"The CAIO Office is accountable for progress, without unverifiable promises",boundaries:[["Not a headcount-reduction program","Make work and capability visible; the client makes organization decisions from evidence."],["No fixed efficiency multiple","Scope, data, systems, and teams differ; measure a baseline before setting targets."],["No bypassing human release authority","AI output passes agreed tests, access controls, and human approval."],["FDE is scoped separately","Agents, code changes, automated tests, integrations, or private deployment require a separate SOW, milestones, evals, and quote."]],trustLabel:"Why Kelly",trustTitle:"Business judgment with hands-on engineering depth",trustText:"Kelly serves as CAIO Lead. He founded Buda, Vika, and AITable and served as founding CTO of HEYTEA. He has led 150+ cross-functional staff, delivered million-line enterprise software, and runs teams and AI against business outcomes.",contactLabel:"Next step",contactTitle:"Bring one real problem. We will identify the right entry track.",contactText:"Prepare the business outcome you want to change, the current owner, one candidate process or repository, and your definition of success. We will first determine whether a CAIO Office and FDE engagement fits.",phone:"Call +86 186 8818 0270",wechat:"Copy WeChat 23110388",copied:"WeChat ID copied",fallback:"Copy manually: 23110388",resume:"About Kelly",back:"Back to Kelly AI services",footer:"Kelly AI Deployment Service"
  },
  "zh-HK": {
    output:"zh-hk/caio/index.html",canonical:"https://mr-kelly.github.io/ai/zh-hk/caio/",title:"CAIO Office｜企業 AI 轉型與研發 AI 原生轉型｜Kelly AI",description:"Kelly 擔任 CAIO Lead，以嵌入式持續合作方式帶隊，涵蓋企業 AI 轉型與研發 AI 原生轉型；每週確定優先級、推進真實業務並驗收結果。",home:"/ai/zh-hk/",nav:["兩種路徑","前 30 天","交付驗收","合作邊界","聯絡"],navTargets:["#paths","#first-30-days","#outcomes","#boundaries","#contact"],eyebrow:"Kelly AI 企業 AI 落地服務",heroTitle:"CAIO Office",heroLead:"由 Kelly 擔任 CAIO Lead，以嵌入式持續合作方式進入管理層和團隊，從經營目標到研發交付，每週推進並驗收最重要的結果。",heroPrimary:"選擇切入路徑",heroSecondary:"聯絡 Kelly",heroSignals:[["企業 AI 轉型","跨部門優先級與業務閉環"],["研發 AI 原生轉型","交付透明、AI Coding 與技術資產"],["FDE 工作包","需要系統實施時按範圍配置"]],problemLabel:"為什麼需要 CAIO",problemTitle:"AI 工具已經很多，真正缺的是把目標、執行和驗收串起來的人",problemIntro:"戰略層知道 AI 重要，員工也開始試工具，但中間沒有人持續決定先做什麼、調動誰來做、怎樣證明做成。CAIO Office 補上的不是一個職位名稱，而是一套經營機制。",problemSignals:[["方向散","各部門自行試工具，沒有公司級優先級。"],["執行斷","建議很多，但沒有負責人、期限和每週推進。"],["結果虛","Demo 做出來了，缺少基線、測試和業務驗收。"],["資產丟","經驗留在個人和聊天記錄中，換人就要重來。"]],pathsLabel:"兩種切入路徑",pathsTitle:"先選擇當前最主要的矛盾",pathsIntro:"兩條路徑共用同一套 CAIO Office 工作節奏，不要求同時採購。可以從研發 AI 原生轉型切入再擴展到企業 AI 轉型，也可以先確定公司級優先級，再進入研發 AI 原生轉型。",paths:[{id:"enterprise",number:"01",title:"企業 AI 轉型",fit:"適合管理層已認可 AI，但部門各自試工具、沒有統一路線和業務閉環的企業。",focus:["從經營目標篩選最值得投入的 AI 場景","協調業務、產品、技術、數據與安全團隊","建立每週執行和每月管理層複盤","讓一個跨部門業務閉環先跑起來"],outputs:["AI 機會與優先級路線圖","跨部門任務與負責人機制","可驗收業務成果與管理層決策"]},{id:"rd",number:"02",title:"研發 AI 原生轉型",fit:"適合研發持續投入卻交付不透明、文檔斷層，或 AI Coding 只停留在局部寫代碼的企業。",focus:["梳理目標、需求、代碼、測試與發布價值流","建立任務／PR／測試／簽收證據鏈","恢復產品、架構、接口與發布文檔","變成團隊可重用的 AI 原生研發方法"],outputs:["研發價值流與交付看板","一個真實任務的完整研發閉環","產品技術資產與團隊優化建議"]}],cadenceLabel:"共同工作節奏",cadenceTitle:"不是交一份報告，而是每週推動一個真實結果",cadenceIntro:"CAIO Office 是客戶與 Kelly 共同成立的虛擬組織，不是遠程給建議的外部顧問。客戶需委派一名種子人員，建議來自業務側——業務的人沒有技術包袱，更敢把 AI 用到極限；代碼落地、系統上線和風險控制仍由技術把關。CTO 可以加入，角色分工在啟動前一起確定。",cadence:[["01","每週問診","和管理層及業務負責人檢查目標、進展、卡點和新機會。"],["02","確定實戰","選定最高優先級任務，明確結果、負責人、期限和驗收標準。"],["03","帶隊執行","協調團隊與 AI Agents 推進業務、數據、流程或系統成果。"],["04","驗收複盤","用證據檢查結果，沉澱方法與資產，排定下一週行動。"]],firstLabel:"前 30 天",firstTitle:"先建立基線，再決定如何擴大",firstIntro:"第一個月不承諾全面改造。先用一個有邊界的真實場景建立信任和數據，具體節奏按系統規模、權限與團隊配合確認。",firstSteps:[["第 1 週","看清現狀","訪談決策人和一線團隊，畫出目標、流程、系統、數據、角色與風險。"],["第 2 週","選定試點","凍結一個高價值、數據可得、能夠人工驗收的場景。"],["第 3 週","跑通閉環","完成任務定義、執行、測試、證據與人工簽收的最小閉環。"],["第 4 週","複盤決策","形成基線、成果、風險和 Go／No-Go 建議，決定繼續、調整或停止。"]],outcomesLabel:"交付與驗收",outcomesTitle:"每週看得見，月底能決策",outcomesIntro:"指標不套用示例數字。先測量當前基線，再由雙方凍結定義、數據範圍、目標門檻和簽收人。",deliverablesTitle:"核心交付",deliverables:["有負責人、期限和完成定義的每週任務清單","一個持續推進並能夠人工驗收的真實業務成果","問題、根因、修改、測試、證據和簽收記錄","方法、文檔、數據、Agent Skills 與下一階段路線圖"],metricsTitle:"常用驗收維度",metrics:["交付週期與等待時間","任務與證據可追溯率","質量、返工與回歸缺陷","人工接管與團隊獨立操作能力","業務結果與管理層決策速度"],boundariesLabel:"合作邊界",boundariesTitle:"CAIO Office 對推進負責，但不製造無法驗證的承諾",boundaries:[["不以裁員為項目目標","先讓任務、產出和能力透明，組織調整由客戶依據事實決定。"],["不承諾固定效率倍數","範圍、數據、系統和團隊不同，先建立基線再設目標。"],["不繞過人工上線","AI 產出必須經過約定測試、權限控制和人工發布授權。"],["FDE 單獨定範圍","涉及 Agent、代碼、自動化測試、系統集成或私有化部署時，另行確認 SOW、里程碑、Evals 和報價。"]],trustLabel:"為什麼是 Kelly",trustTitle:"既看經營，也能進入研發一線",trustText:"Kelly 擔任 CAIO Lead。他是 Buda、Vika 與 AITable 創始人、前喜茶創始 CTO。擁有百萬行級企業軟件研發與交付經驗，帶過 150 人以上跨職能團隊，也長期以業務目標驅動團隊與 AI 協作。",contactLabel:"下一步",contactTitle:"帶一個真實問題來，先判斷從哪條路徑切入",contactText:"準備好最希望改變的業務結果、當前負責人、一個候選流程或代碼倉庫，以及你認為「做成」的標準。我們先做一次需求判斷，再確認是否適合 CAIO Office 和 FDE。",phone:"電話 18688180270",wechat:"複製微信 23110388",copied:"微信號已複製",fallback:"請手動複製微信號：23110388",resume:"了解 Kelly",back:"返回 Kelly AI 服務",footer:"Kelly AI Deployment Service"
  }
};
