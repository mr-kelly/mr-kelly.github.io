...
const pages = {
  "zh-CN": {
    ...
    insightsItems: [
      ...
      ["下一家万亿美元公司，卖的不是工具，是把活干完", "红杉《Services: The New Software》全文中译，加一份买方视角的批注：怎样从已外包的支出里挑出第一条能按结果买的线。", "企业 AI · 译文批注", "/articles/services-the-new-software.html"]
    ],
  ...
  en: {
    ...
    insightsItems: [
      ...
      ["The next $1T company sells the work, not the tool", "A full Chinese translation of Sequoia's Services: The New Software, annotated from the buyer's side.", "Enterprise AI · Translation", "/articles/services-the-new-software.html"]
    ],
  ...
  "zh-HK": {
    ...
    insightsItems: [
      ...
      ["下一家萬億美元公司，賣的不是工具，是把活幹完", "紅杉《Services: The New Software》全文中譯，加一份買方視角的批註：怎樣從已外包的支出裡挑出第一條能按結果買的線。", "企業 AI · 譯文批註", "/articles/services-the-new-software.html"]
    ],
