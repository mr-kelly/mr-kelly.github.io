...
const pages = {
  "zh-CN": {
    ...
    insightsIntro: "五篇长文分别从 FDE 岗位真相、企业 AI 落地、研发团队改造、Agents 公司管理和交付验收切入，讲清问题为什么发生、应该怎样推进。",
    insightsCta: "阅读全文",
    insightsItems: [
  ...
  en: {
    ...
    insightsIntro: "Five Chinese long-form essays cover the FDE role, enterprise AI deployment, AI-native R&D transformation, managing an Agents company, and acceptance.",
  ...
  "zh-HK": {
    ...
    insightsIntro: "五篇長文分別從 FDE 崗位真相、企業 AI 落地、研發團隊改造、Agents 公司管理和交付驗收切入，講清問題為什麼發生、應該怎樣推進。",
    insightsCta: "閱讀全文",
    insightsItems: [
