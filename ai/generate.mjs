...
const pages = {
  "zh-CN": {
    ...
    consultMeta: "交付周期 3–7 天｜适合作为培训、兼职 CAIO 或 Vibe Coding 陪跑前的第一步｜咨询费用可抵扣后续 CAIO 或 Vibe Coding 陪跑款",
    trainingLabel: "培训",
    ...
    trainingFitNoText: "团队已经完成过认知建设，需要的是持续带队做出业务成果——可以直接看兼职 CAIO 或 Vibe Coding 陪跑。",
    trainingOffers: [
  ...
  en: {
    ...
    consultMeta: "3–7 day turnaround | A natural first step before training, fractional CAIO, or Vibe Coding coaching | The fee is credited toward a follow-on CAIO or Vibe Coding engagement",
    ...
    trainingFitNoText: "The team has already built that awareness and needs sustained leadership toward business outcomes — go straight to a fractional CAIO or Vibe Coding coaching instead.",
    trainingOffers: [
  ...
  "zh-HK": {
    ...
    consultMeta: "交付週期 3–7 天｜適合作為培訓、兼職 CAIO 或 Vibe Coding 陪跑前的第一步｜諮詢費用可抵扣後續 CAIO 或 Vibe Coding 陪跑款",
    trainingLabel: "培訓",
    ...
    trainingFitNoText: "團隊已經完成過認知建設，需要的是持續帶隊做出業務成果——可以直接看兼職 CAIO 或 Vibe Coding 陪跑。",
    trainingOffers: [
